...
folder_url = "https://drive.google.com/drive/folders/1PLu92cYeoMiTv46sDYMRYJT7u4TrRmHW"
...
WRTDS_DSi = csv_files[csv_files$name %like% "Si_WRTDS.csv",]
...
setwd("L:/GitHub/SiSyn/Merge Site Discharge/Merge site DSi")
write.csv(all_DSi, file="WRTDS_DSi_allsites.csv")
