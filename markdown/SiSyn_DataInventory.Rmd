...
subset(unit.all,Measurement=="TN")
subset(unit.all,Measurement=="DIN")
N.cf=data.frame(Measurement=c("TN","DIN"),Unit=c("mg N/L"),CF=c((1/N.mw)*1000))
subset(unit.all,Measurement=="NOX")
NOX.cf=data.frame(Measurement="NOX",
                  Unit=c("uM NO3","mg NO3-N/L","ug NO3-N/L","ueq/L"),
                  CF=c(NO3.mw/N.mw,(1/N.mw)*1000,1/N.mw,NO3.mw*(NO3.mw/N.mw)))
subset(unit.all,Measurement=="NO3")
NO3.cf=data.frame(Measurement="NO3",Unit=c("ug/L"),CF=c(1/N.mw))
subset(unit.all,Measurement=="NH4")
NH4.cf=data.frame(Measurement="NH4",
                  Unit=c("ueq/L","ug NH4/L","mg NH4-N/L","ug NH4-N/L"),
                  CF=c(NH4.mw*(NH4.mw/N.mw),((1/NH4.mw)*(NH4.mw/N.mw)),(1/N.mw)*1000,(1/N.mw)))
subset(unit.all,Measurement=="TDN")
subset(unit.all,Measurement=="DON")
subset(unit.all,Measurement=="DTN")
other.N=data.frame(Measurement=c(rep("TDN",2),"DON","DTN"),
                   Unit=c("mg N/L","mg/L","ug/L","ug/L"),
                   CF=c(rep((1/N.mw)*1000,2),rep(1/N.mw,2)))
subset(unit.all,Measurement=="TP")
TP.cf=data.frame(Measurement=c("TP"),Unit=c("mg P/L"),CF=c((1/P.mw)*1000))
subset(unit.all,Measurement=="PO4")
PO4.cf=data.frame(Measurement=c("PO4"),
                 Unit=c("ueq/","ug PO4-P/L","mg PO4-P/L","mg PO4/L"),
                 CF=c(PO4.mw*(PO4.mw/P.mw),(1/P.mw),(1/P.mw)*1000,((1/PO4.mw)*(PO4.mw/P.mw))*1000))
subset(unit.all,Measurement=="SRP")
SRP.cf=data.frame(Measurement=c("SRP"),
                 Unit=c("ug P/L","mg P/L"),
                 CF=c(1/P.mw,(1/P.mw)*1000))
subset(unit.all,Measurement=="TOC")
C.cf=data.frame(Measurement=c("DOC","TOC"),Unit=c("mg C/L"),CF=c((1/C.mw)*1000))

cf.all=rbind(Si.CF,N.cf,NOX.cf,NO3.cf,NH4.cf,other.N,TP.cf,PO4.cf,SRP.cf)
