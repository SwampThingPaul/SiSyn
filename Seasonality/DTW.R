...
ggplot(month_melt, aes(Month, value))+geom_line(aes(col=variable))+
...
names(biomes)[2]<-"variable"

month_clusters<-merge(month_clusters, biomes, by="variable")
...
ggplot(month_clusters, aes(Month, value))+geom_path(aes(col=Biome_new, group=variable))+
