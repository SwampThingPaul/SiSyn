...
## NOTES before running loop ##
# stopped at # 21 - WP02.6M_Q won't download Q file ("duplicate"), did manually
# skipped files 51-52 - "identifies more than one file", did manually 
...
for (i in 1:length(WRTDS_files)) {
  ...
  #read in Si file
  Sample<-readUserSample("C:/Users/kjankowski/Desktop/WRTDS_prep", WRTDS_files_List_Si[1])
