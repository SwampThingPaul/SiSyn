...
WRTDS_files_List<-list.files(path = "C:/Users/kjankowski/Desktop/WRTDS_prep_")

#WRTDS_files_List_HBR <- WRTDS_files_List[WRTDS_files_List %like% "ws"]
...
for (i in 1:length(WRTDS_files)) {
  ...
  #read in Q file
  Daily<-readUserDaily("C:/Users/kjankowski/Desktop/WRTDS_prep", WRTDS_files_List_Q[i],
                       qUnit = 2)
  
  #read in Si file
  Sample<-readUserSample("C:/Users/kjankowski/Desktop/WRTDS_prep", WRTDS_files_List_Si[i])
  
  #read in Info file
  Info<-readUserInfo("C:/Users/kjankowski/Desktop/WRTDS_prep", WRTDS_files_List_Info[i])
  ...
  savePath<-"C:/Users/kjankowski/Desktop/WRTDSResults_Si/"
  ...
  write.csv(ContConc, paste0(WRTDS_files[i], "_ContSi_WRTDS.csv"))
  ...
  write.csv(Summary, paste0(WRTDS_files[i], "_Si_EGRETCi_Trend.csv"))
