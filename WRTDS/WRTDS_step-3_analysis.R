...
odd_ones <- c(
  ...
  "UK__EAMONT AT UDFORD_DSi", "UK__NORTH TYNE AT REAVERHILL_DSi", 
  ...
  "UK__OUSE AT BARCOMBE MILLS_DSi", "UK__OUSE AT SKELTON_DSi",
  "UK__PLYM AT CARN WOOD_DSi", "UK__ROTHER AT WOODHOUSE MILL_DSi",
  "UK__SEVERN AT HAW BRIDGE_DSi", "UK__SOAR AT KEGWORTH_DSi",
